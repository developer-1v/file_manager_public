...
class FileManagerDialog:
    def __init__(self):
        self.main_window = Tk()
        self.main_window.title('File Manager')  # Translated title
        ...
        self.__back_button = Button(self.main_window, text="Back")  # Translated text
        self.__back_button.grid(row=0, column=0, sticky="nwes")
        self.__back_button.bind("<Button-1>", self.back_button_onclick)
        self.__program_info_button = Button(self.main_window, text="About the Program")  # Translated text

        self.__forward_button = Button(self.main_window, text="Forward")  # Translated text
        self.__forward_button.grid(row=0, column=4, sticky="nwes")
        self.__forward_button.bind("<Button-1>", self.forward_button_onclick)

        self.__find_button = Button(self.main_window, text="Search", command=self.find_button_onclick)  # Translated text
        ...
        self.__copy_button = Button(self.main_window,        text="Copy", width=8)  # Translated text
        self.__move_button = Button(self.main_window,        text="Move", width=8)  # Translated text
        self.__rename_button = Button(self.main_window,      text="Rename", width=8)  # Translated text
        self.__create_file_button = Button(self.main_window, text="Create File", width=8)  # Translated text
        self.__mkdir_button = Button(self.main_window,       text="Create Folder", width=8)  # Translated text
        self.__delete_button = Button(self.main_window,      text="Delete", width=8)  # Translated text
        self.__info_button = Button(self.main_window,        text="Properties", width=8)  # Translated text
        self.__zip_button = Button(self.main_window,         text="Archive", width=8)  # Translated text
        self.__unzip_button = Button(self.main_window,       text="Unarchive", width=8)  # Translated text
        self.__soft_link_button = Button(self.main_window,   text="Create Soft Link", width=8)  # Translated text
        self.__hard_link_button = Button(self.main_window,   text="Create Hard Link", width=8)  # Translated text
